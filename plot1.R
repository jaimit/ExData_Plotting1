...
### Convert the date variable from character to Date type using as.Date()
...
hist(as.numeric(smallData$globalactivepower), col="red", main="Global Active Power", xlab="Global Active Power (kilowatts)")
dev.off()
